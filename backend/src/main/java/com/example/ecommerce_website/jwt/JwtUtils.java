...
public class JwtUtils {
    ...
    @Value("${ecommerce_website.app.jwtSecret}")
    private String jwtSecret;

    @Value("${ecommerce_website.app.jwtExpirationMs}")
    ...
    public String refreshToken(String token) {
        ...
        final Date expirationDate = new Date(createdDate.getTime() + jwtExpirationMs * 1000L);
